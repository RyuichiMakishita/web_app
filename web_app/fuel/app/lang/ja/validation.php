...
return array(
		...
		'valid_url'       => ':label は有効なURLを入力してください。',
		'valid_ip'        => ':label は有効なIPアドレスを入力してください。',
		'numeric_min'     => ':label は :param:1 より大きい数値を入力してください。',
		'numeric_max'     => ':label は :param:1 より小さい数値を入力してください。',
		'numeric_between' => ':label は :param:1 以上 :param:2 以内の数値を入力してください。',
		'valid_string'    => ':label は :rule(:param:1) で入力してください。',
